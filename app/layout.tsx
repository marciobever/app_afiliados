  ...
  return (
    <html lang="pt-BR">
      <body className={`${inter.className} bg-white text-gray-900 antialiased`}>
        ...
        <main className="min-h-[70vh] mx-auto max-w-7xl px-4 py-8">
          {children}
        </main>
        ...
        <footer className="border-t mt-10">
          <div className="mx-auto max-w-7xl px-4 py-8 text-sm text-gray-600">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <a href="https://seureview.com.br" className="flex items-center gap-2">
                <Logo size={24} withText />
              </a>
              <nav className="flex items-center gap-4">
                <a href="https://seureview.com.br/privacidade" className="hover:text-gray-900">Privacidade</a>
                <a href="https://seureview.com.br/termos" className="hover:text-gray-900">Termos</a>
                <a href="https://seureview.com.br/exclusao-de-dados" className="hover:text-gray-900">Exclusão de dados</a>
