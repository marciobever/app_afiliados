...
export async function POST(req: NextRequest) {
  try {
    ...
    // Do front esperamos: { platform, product, trackedUrl, caption, scheduleTime? }
      ...
      return NextResponse.json(
        {
          ...
          message:
            'Credenciais/informações insuficientes para publicar. Verifique suas permissões do Facebook/Instagram.',
          missing,
        },
        { status: 400 }
      )
